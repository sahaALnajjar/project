...
public class proverbsHolder extends AppCompatActivity {
        ...
        playSound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mediaPlayer = MediaPlayer.create(proverbsHolder.this, audio);
        ...
        playsoundExample.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // Create and setup the {@link MediaPlayer} for the audio resource associated
                    // with the current word
                    mediaPlayer = MediaPlayer.create(proverbsHolder.this, exampleAudio);
        ...
        playsoundEnglish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // Create and setup the {@link MediaPlayer} for the audio resource associated
                    // with the current word
                    mediaPlayer = MediaPlayer.create(proverbsHolder.this, englishAudio);
...
//        prefs.getBookingInfo();
        ...
        bookmark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPrefs prefs = new SharedPrefs(proverbsHolder.this);
                if (bookmarking) {
