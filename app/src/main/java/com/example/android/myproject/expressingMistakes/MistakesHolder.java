...
public class MistakesHolder extends AppCompatActivity {
        ...
        playSound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mediaPlayer = MediaPlayer.create(MistakesHolder.this, audio);
        ...
        playsoundExample.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // Create and setup the {@link MediaPlayer} for the audio resource associated
                    // with the current word
                    mediaPlayer = MediaPlayer.create(MistakesHolder.this, exampleAudio);
        ...
        playsoundEnglish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // Create and setup the {@link MediaPlayer} for the audio resource associated
                    // with the current word
                    mediaPlayer = MediaPlayer.create(MistakesHolder.this, englishAudio);
